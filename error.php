...
<head>
    ...
    <style>
        ...
        .error-box { background: #fff; border-radius: 16px; padding: 48px 44px; max-width: 420px; width: 100%; text-align: center; box-shadow: 0 8px 32px rgba(0,0,0,0.1); }
        .error-icon { font-size: 3rem; color: #dc2626; margin-bottom: 16px; }
...
<body>
    <div class="error-box">
        ...
        <p>An unexpected error occurred. The system administrator has been notified. Please try again or go back to the dashboard.</p>
        <a href="/cap/dashboard.php"><i class="bi bi-house"></i> Back to Dashboard</a>
    </div>
</body>
</html>
